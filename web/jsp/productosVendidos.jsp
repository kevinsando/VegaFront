...
<html>
    <head>
        ...
        <script src="../js/scriptMes.js" type="text/javascript"></script>
        ...
        <div>
            <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link disabled" href="productosVendidos.jsp">Reporte ventas del mes</a>
                    </li>
                </ul>
            </nav>
        </div>
        <div id="contentsMenos">
            ...
            <table class="table tablaExis1">
                <thead class="thead-dark">
                    <tr>
                        <th colspan="3"><h2>Reporte ventas del mes</h2></th>
                    </tr>
                </thead> 
            </table>
